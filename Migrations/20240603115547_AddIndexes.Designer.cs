...
namespace KanzApi.Migrations
{
    ...
    [Migration("20240603115547_AddIndexes")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KanzApi.Product.Entities.ProductProperty", b =>
                {
                    b.Property<int?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProductProperty", "Product");
                });

            modelBuilder.Entity("KanzApi.Product.Entities.ProductPropertyItem", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool?>("SaveAsAttribute")
                        .IsRequired()
                        .HasColumnType("bit");
                    ...
                    b.ToTable("ProductPropertyItem", "Product");
                });
            ...
            modelBuilder.Entity("KanzApi.Product.Entities.Attribute", b =>
                {
                    ...
                    b.HasOne("KanzApi.Product.Entities.Category", "Category")
                        .WithMany()
                    ...
                    b.OwnsOne("System.Collections.Generic.List<KanzApi.Product.Models.AttributeOption>", "Options", b1 =>
                        {
                            b1.Property<int>("AttributeId")
                                .HasColumnType("int");
            ...
            modelBuilder.Entity("KanzApi.Product.Entities.ProductProperty", b =>
                {
                    ...
                    b.OwnsMany("KanzApi.Common.Models.LocalizableString", "Fields", b1 =>
                        {
                            b1.Property<int>("ProductPropertyId")
                                .HasColumnType("int");
                            ...
                            b1.HasKey("ProductPropertyId", "Id");

                            b1.ToTable("ProductProperty", "Product");
            ...
            modelBuilder.Entity("KanzApi.Product.Entities.ProductPropertyItem", b =>
                {
                    ...
                    b.HasOne("KanzApi.Product.Entities.ProductProperty", "Property")
                        .WithMany("Items")
                    ...
                    b.OwnsOne("KanzApi.Common.Models.LocalizableString", "Description", b1 =>
                        {
                            b1.Property<Guid>("ProductPropertyItemId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasKey("ProductPropertyItemId");

                            b1.ToTable("ProductPropertyItem", "Product");

                            b1.ToJson("Description");

                            b1.WithOwner()
                                .HasForeignKey("ProductPropertyItemId");
                        });
                    ...
                    b.OwnsOne("KanzApi.Common.Models.LocalizableString", "Unit1", b1 =>
                        {
                            b1.Property<Guid>("ProductPropertyItemId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsOne("KanzApi.Common.Models.LocalizableString", "Unit2", b1 =>
                        {
                            b1.Property<Guid>("ProductPropertyItemId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsOne("KanzApi.Common.Models.LocalizableString", "Unit3", b1 =>
                        {
                            b1.Property<Guid>("ProductPropertyItemId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsOne("KanzApi.Common.Models.LocalizableString", "Value1", b1 =>
                        {
                            b1.Property<Guid>("ProductPropertyItemId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsOne("KanzApi.Common.Models.LocalizableString", "Value2", b1 =>
                        {
                            b1.Property<Guid>("ProductPropertyItemId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsOne("KanzApi.Common.Models.LocalizableString", "Value3", b1 =>
                        {
                            b1.Property<Guid>("ProductPropertyItemId")
                                .HasColumnType("uniqueidentifier");
